...
export default class Player extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor(scene, x, y, shipId) {
        ...
        this.setAngle(90); // rotate the ship to face right (optional, based on sprite)
    }
    ...
    fire() {
        ...
        // Fire a bullet rightward from the front of the ship
        this.scene.fireBullet(this.x + this.width * 0.5, this.y);
    }
